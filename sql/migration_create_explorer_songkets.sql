-- Migration: create explorer_songkets and explorer_songket_images
-- Run this in Supabase SQL editor or psql connected to your project's DB

-- Create explorer_songkets table (separate from datasets used for ML)
...
-- Images table for gallery items (relational)
...
-- Seed built-in six songkets if they do not exist. These are marked is_builtin = true
DO $$
BEGIN
